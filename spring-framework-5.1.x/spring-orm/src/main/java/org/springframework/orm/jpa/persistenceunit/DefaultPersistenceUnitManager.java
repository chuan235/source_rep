 ...
 *
 * <p>The default XML file location is {@code classpath*:WEB-INF/persistence.xml},
...
public class DefaultPersistenceUnitManager
	 ...
	 * "classpath*:WEB-INF/persistence.xml".
	 */
	public static final String DEFAULT_PERSISTENCE_XML_LOCATION = "classpath*:WEB-INF/" + PERSISTENCE_XML_FILENAME;
	 ...
	 * <p>Default is "classpath*:WEB-INF/persistence.xml".
	 */
	 ...
	 * {@code WEB-INF/orm.xml} file in the classpath, registering it as a mapping
	 ...
	 * e.g. "WEB-INF/mappings.xml" or "com/mycompany/repository/mappings.xml",
	 ...
	 * {@code WEB-INF/orm.xml} check. On the other hand, explicitly specifying
	 * {@code WEB-INF/orm.xml} here will register that file even if it happens
	...
	/**
	 * Determine JPA's default "WEB-INF/orm.xml" resource for use with Spring's default
	 * persistence unit, if any.
	 * <p>Checks whether a "WEB-INF/orm.xml" file exists in the classpath and uses it
	 * if it is not co-located with a "WEB-INF/persistence.xml" file.
	 */
	@Nullable
