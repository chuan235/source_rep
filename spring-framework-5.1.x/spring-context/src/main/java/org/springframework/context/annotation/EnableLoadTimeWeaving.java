 ...
 * activated by default if a "WEB-INF/aop.xml" resource is present on the classpath.
 * Example:
 *
 * <pre class="code">
 * &#064;Configuration
...
public @interface EnableLoadTimeWeaving {
	...
	enum AspectJWeaving {
		 ...
		 * "WEB-INF/aop.xml" resource is present on the classpath).
		 */
		DISABLED,

		/**
		 * Switches on AspectJ load-time weaving if a "WEB-INF/aop.xml" resource
