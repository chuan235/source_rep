...
public class LoadTimeWeavingConfiguration implements ImportAware, BeanClassLoaderAware {
	...
	public void setImportMetadata(AnnotationMetadata importMetadata) {
		// 将 EnableLoadTimeWeaving 注解的信息保存下来
	...
	/**
	 * 核心方法 向容器中注入 loadTimeWeaver
	 * => 一旦容器中存在了这个loadTimeWeaver => AbstractApplicationContext#prepareBeanFactory
	 * => 向容器中注入  LoadTimeWeaverAwareProcessor 和 ContextTypeMatchClassLoader
	 * @return
	 */
