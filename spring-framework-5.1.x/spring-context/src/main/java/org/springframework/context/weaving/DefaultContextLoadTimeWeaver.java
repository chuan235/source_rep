...
/**
 * spring默认的LoadTimeWeaver bean对象，beanName=loadTimeWeaver
 * 通过<context:load-time-weaver>标签在xml中配置
 * <context:load-time-weaver  aspectj-weaving="autodetect" />
 *  这个aspectj-weaving有三个取值，on、off或者autodetect，默认是autodetect，也就是说我们只是在使用了aspectJ
 *  但是具体能否使用需要Spring自己去检测	WEB-INF/aop.xml 这个文件是否存在，
 * 参考：LoadTimeWeaverBeanDefinitionParser#isAspectJWeavingEnabled(java.lang.String, ParserContext)
 *
