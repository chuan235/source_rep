...
public class DefaultRequestToViewNameTranslator implements RequestToViewNameTranslator {
	...
	/**
	 * Translates the request URI of the incoming {@link HttpServletRequest} into the view name based on the configured parameters.
	 * @see org.springframework.web.util.UrlPathHelper#getLookupPathForRequest
	 * @see #transformPath
	 * 根据请求的配置参数将请求的URI转换为视图名称
	 */
	@Override
	public String getViewName(HttpServletRequest request) {
		// 获取请求的路径 servlet mapping = "/test/*"; request URI = "/test/a" -> "/a"
		// 如果请求和映射相同 这里会直接返回请求的URI
	...
	protected String transformPath(String lookupPath) {
		...
		if (this.stripExtension) {
			// 移除后缀 "mypath/myfile.txt" -> "mypath/myfile".
