...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	 ...
	 * 不进行自动装配，但是可以进行注解装配 @AutoWire @Resource
	 * @see #setAutowireMode
	 */
	 ...
	 * 为这个bd指定特定的	工厂方法，factoryMethod这个方法将会使用bd className中的构造函数的参数作为参数，没有则不需要参数
	 * 可能在静态方法或者factoryBean上调用
