 ...
 * pattern: {@code WEB-INF/spring.schemas} allowing for multiple files to exist on
 * the classpath at any one time.
 *
 * <p>The format of {@code WEB-INF/spring.schemas} is a properties file where each line
...
public class PluggableSchemaResolver implements EntityResolver {
	 ...
	 * mapping file pattern "WEB-INF/spring.schemas".
