...
public abstract class BeanDefinitionReaderUtils {
	...
	public static void registerBeanDefinition(
		...
		// 向容器中添加一个bean
		// 调用了 DefaultListableBeanFactory.registerBeanDefinition 方法
		// 具体向beanDefinitionMap、beanDefinitionNames添加了数据
		...
		if (aliases != null) {
			for (String alias : aliases) {
				// 在GenericApplicationContext.registerAlias => SimpleAliasRegistry.registerAlias注册别名
