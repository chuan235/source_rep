 ...
 * to such components.
 *
 * <p>This ResourceAdapter is to be defined in a "WEB-INF/ra.xml" file
 ...
 *			 &lt;config-property-value&gt;WEB-INF/applicationContext.xml&lt;/config-property-value&gt;
 *		 &lt;/config-property&gt;
 *	 &lt;/resourceadapter&gt;
 * &lt;/connector&gt;</pre>
 *
 * Note that "WEB-INF/applicationContext.xml" is the default context config
 ...
 * into the root of the RAR archive, add a "WEB-INF/ra.xml" deployment
 * descriptor as shown above as well as the corresponding Spring XML bean
 * definition file(s) (typically "WEB-INF/applicationContext.xml"),
...
public class SpringContextResourceAdapter implements ResourceAdapter {
	 ...
	 * <p>The default is "classpath:WEB-INF/applicationContext.xml".
	 */
