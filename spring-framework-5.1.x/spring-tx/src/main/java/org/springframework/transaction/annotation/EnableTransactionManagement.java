...
public @interface EnableTransactionManagement {
	 ...
	 * 是使用jdk的动态代理还是cglib的代理
	 * 默认为false，默认使用jdk的动态代理
	 * 是否使用cglib代理
	 */
	boolean proxyTargetClass() default false;

	/**
	 * Indicate how transactional advice should be applied. 如何应用事务的通知
	 ...
	 * an {@link Transactional} annotation on such a method within a local call will be
