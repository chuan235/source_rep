 ...
 * "{@code classpath*:WEB-INF/beans.xml}" will find all "beans.xml"
 ...
 * the rest of the location path, for example "classpath*:WEB-INF/*-beans.xml".
...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	 ...
	 * 通过ant风格的pathmatcher查找与给定位置模式匹配的所有资源。支持jar文件、zip文件和文件系统中的资源
