...
public class ZooKeeper {
    ...
    private static class ZKWatchManager implements ClientWatchManager {
        ...
        /**
         * @see ClientWatchManager#materialize
         */
        @Override
        public Set<Watcher> materialize(Watcher.Event.KeeperState state,
            ...
            switch (type) {
                ...
                case NodeCreated:
                    synchronized (dataWatches) {
                        // 首先移除 dataWatches 中的watcher，然后在添加到一个set集合中
    ...
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher, boolean canBeReadOnly) throws IOException {
        ...
        // 格式化host:port 将地址解析为一个 InetSocketAddress
        ConnectStringParser connectStringParser = new ConnectStringParser(connectString);
        HostProvider hostProvider = new StaticHostProvider(connectStringParser.getServerAddresses());
        // ClientContext 客户端的上下文
    ...
    public String create(final String path, byte data[], List<ACL> acl, CreateMode createMode)
        ...
        request.setAcl(acl);
        // RequestHeader + CreateRequest + CreateResponse + WatchRegistration
        // 包装为一个ReplyHeader,并且会阻塞在这里
    ...
    public byte[] getData(final String path, Watcher watcher, Stat stat) throws KeeperException, InterruptedException {
        ...
        WatchRegistration wcb = null;
        if (watcher != null) {
            // 每一个watcher都对应的一个DataWatchRegistration
        ...
        request.setPath(serverPath);
        // reuqest的wathch只是一个标识，标识这个请求是否存在watcher
        request.setWatch(watcher != null);
