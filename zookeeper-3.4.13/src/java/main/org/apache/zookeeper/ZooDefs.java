...
public class ZooDefs {
    ...
    public interface Ids {
        /**
         * This Id represents anyone. anyone的权限模式，还需要添加权限标识
         */
        ...
        /**
         * This is a completely open ACL . 默认的权限，任何用户都有cdrwa权限
         * 'world,'anyone
         * : cdrwa
         */
         ...
         * 当前创建节点的具有所有权限，指定用户具有所有权限
         */
        public final ArrayList<ACL> CREATOR_ALL_ACL = new ArrayList<ACL>(
                Collections.singletonList(new ACL(Perms.ALL, AUTH_IDS)));

        /**
         * This ACL gives the world the ability to read. 所有人都只能读
         */
